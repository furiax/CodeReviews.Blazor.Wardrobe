    ...
    public class WardrobeContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Clothpiece>().HasData(
                ...
                new Clothpiece { Id = 3, Type = Shared.Entities.ClothType.Shoes, Brand = "Addidas", Color = "white", ImageUrl = "https://www.torfs.be/dw/image/v2/BCQR_PRD/on/demandware.static/-/Sites-torfs-catalog-master/default/dwe08d8d54/hi-res/pdp/319/319013/319013-3.jpg?sw=820" }
                );
        }
